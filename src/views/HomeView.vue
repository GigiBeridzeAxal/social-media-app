        ...
        <aside class="sidebar">
          ...
          <nav class="sidebar-nav">
            ...
            >
              ...
              <!-- Settings icon -->
              <svg v-else-if="link.icon === 'settings'" width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
